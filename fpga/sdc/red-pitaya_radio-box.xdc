...
set_input_delay -clock rx_clk -min 1.000 [get_ports {daisy_p_i[0]}]
set_input_delay -clock rx_clk -max 2.400 [get_ports {daisy_p_i[0]}]

# DNA clock
create_clock -period 64.000 -name dna_clk [get_nets i_hk/dna_clk_i]
